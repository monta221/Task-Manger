    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <button class="btn btn-sm btn-link show-tasks-btn" data-project-id="{{ $projet->projet_id }}">
                     View Tasks
                </button>
            ...
            <td>
                <a href="{{ route('projets.edit', $projet->projet_id) }}" class="btn btn-warning btn-sm">Edit</a>
