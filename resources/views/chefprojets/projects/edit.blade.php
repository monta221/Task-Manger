...
<div class="container mt-3">
    ...
    <form action="{{ route('chefprojets.update_project', $projet->projet_id) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" name="dateFin" value="{{ old('dateFin', $projet->dateFin) }}">
        </div>
